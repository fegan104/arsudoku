...
import com.frankegan.ar_sudoku.*
import java.io.File
...
class HomeFragment : Fragment(),
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@HomeFragment.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@HomeFragment.cameraDevice = null
        }
        ...
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                val largest = map.getOutputSizes(ImageFormat.JPEG)
                        .maxBy { it.width * it.height } ?: return
    ...
    /**
     * Opens the camera specified by [HomeFragment.cameraId].
     */
    ...
    companion object {
        ...
        private fun chooseOptimalSize(
            ...
            if (bigEnough.size > 0) {
                ...
                return notBigEnough.maxBy { it.height * it.width }!!
            } else {
